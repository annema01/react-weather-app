  ...
  return (
    <div className='Forcast'>
      ...
      <div className='container'>
        ...
        <i className='bi bi-caret-right-fill  smVersion forcastCaret'></i>
        <i className='bi bi-caret-down-fill  lgVersion forcastCaret'></i>
      </div>
      {/*  Collapsable element  */ }
      <div
        className={ `collapse collapse-horizontal ` + props.collapse }
        id={ props.collapse }
      >
